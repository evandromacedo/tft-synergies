...
export default function SynergyDetails() {
  return (
    <S.Wrapper>
      <S.Header>
        <SvgBrawler />
        <S.Name>Brawler</S.Name>
      </S.Header>
      <S.Description>Brawlers gain bonus Maximum Health.</S.Description>
      <S.SynergyList>
        <S.SynergyItem>(2) 250 Bonus Health</S.SynergyItem>
        <S.SynergyItem className="active">(4) 500 Bonus Health</S.SynergyItem>
        <S.SynergyItem>(6) 900 Bonus Health</S.SynergyItem>
      </S.SynergyList>
    </S.Wrapper>
  );
}

const SvgBrawler = props => (
